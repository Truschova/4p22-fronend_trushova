...
const oneNumberNode = document.getElementById("number-one");
const operatorNode = document.getElementById("operator")
const twoNumberNode = document.getElementById("number-two");
